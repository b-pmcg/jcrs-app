var FullTextSearchView = {

    elem: '#content',
    template: 'fulltextsearch',
    ...
    bindEvents: function() {
        ...
        $('#ftsSearch').click(function(event) {
            event.preventDefault();
            App.Views.FullTextSearch.create(event);
        });
