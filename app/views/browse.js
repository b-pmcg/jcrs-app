var BrowseView = {
    ...
    bindEvents: function() {
        ...
        $('ul.ul-letters li').click(function(event) {
            var $elementClick = $(this).attr("id");
            event.preventDefault();
            App.Views.Browse.create(event, $elementClick);
        });
    },
    ...
    render: function() {
        ...
        $(this.elem).load('app/templates/' + this.template + '.html', function() {
            App.Views.Browse.init();
        });
    },

    create: function(event, $elementClick) {

        event.preventDefault();

        var callback = function(response) {
            var $divPanel = $('#result-content');
